...
struct __A { 
    ...
    static String Something$String( A , String);
    static String Something$String$String( A , String , String);
...
struct __A_VT{
    ...
    String (*Something$String) (A , String);
    String (*Something$String$String) (A , String , String);
    ...
    __delete(&__rt::__delete<__A>),
      ...
      Something$String((String(*)(A , String))&__A::Something$String),

      Something$String$String(&__A::Something$String$String) {
    }
};
